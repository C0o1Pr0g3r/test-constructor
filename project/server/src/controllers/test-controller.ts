...
class TestController {
    ...
    async getBriefTestsCreatedByUser(
        ...
        try {
            ...
            console.log("\n\n\n");
            res.json({message: "Brief tests created by user received successfully.", payload: briefTests});
        } catch (e) {
            next(e);
        }
    }
    ...
    async getBriefTestsPassedByUser(
        req: Request<ParamsDictionary, Report<BriefPassedTest[]>, unknown, ParsedQs, Record<string, unknown>>,
        ...
        try {
            ...
            console.log(briefTests);
            console.log("\n\n\n");
            res.json({message: "Brief tests passed by user received successfully.", payload: briefTests});
        } catch (e) {
            next(e);
        }
    }
    ...
    async createPassedTest(
        ...
        try {
            const test = req.body;
            const testId = await testService.createPassedTest((req as unknown as {userId: number}).userId, test);
