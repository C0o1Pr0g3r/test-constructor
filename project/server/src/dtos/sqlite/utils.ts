...
export function convertUserFieldNameToColumnName(fieldName: UserFieldName): UserColumnName {
    ...
    case "activationLink": return "activation_link"; break;
    case "isActivated": return "is_activated"; break;
    }
}

export function convertSessionFieldNameToColumnName(fieldName: SessionFieldName): SessionColumnName {
    switch(fieldName) {
    case "id": return "id"; break;
    case "userId": return "user_id"; break;
    case "refreshToken": return "refresh_token"; break;
