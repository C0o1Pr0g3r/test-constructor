...
export interface DAO {
    ...
    createUser(email: User["email"], password: User["password"], activationLink: User["activationLink"]): Promise<User["id"]>;
    ...
    createSession(userId: User["id"], refreshToken: Session["refreshToken"], expires: Session["expires"]): Promise<Session["id"]>;
    getSessionBy<T extends SessionFieldName>(fieldName: T, value: Session[T]): Promise<Session | undefined>;
    updateSessionBy<T extends SessionFieldName>(fieldName: T, value: Session[T], refreshToken: Session["refreshToken"], expires: Session["expires"]): Promise<void>;
